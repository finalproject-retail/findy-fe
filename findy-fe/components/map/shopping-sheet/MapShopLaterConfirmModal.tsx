...
type MapShopLaterConfirmModalProps = {
  visible: boolean;
  onCancel: () => void;
  onConfirm: () => void;
};

export function MapShopLaterConfirmModal({
  visible,
  onCancel,
  onConfirm,
}: MapShopLaterConfirmModalProps) {
  return (
    <Modal
      visible={visible}
      transparent
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={styles.card} accessibilityViewIsModal>
          <Text style={styles.title}>정말 쇼핑을 종료하시겠습니까?</Text>
          <Text style={styles.message}>확인을 누르시면 쇼핑 리스트가{"\n"}비워집니다.</Text>
